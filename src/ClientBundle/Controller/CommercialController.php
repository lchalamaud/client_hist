...
{	
	...
	public function addCommercial(Request $request)
	{
		...
		return $this->render('@Client/Default/commercialForm.html.twig', array('form' => $form->createView(),
		));
	}
	...
	*/
	...
	{
		$repository = $this->getDoctrine()->getManager()->getRepository('ClientBundle:Commercial');
	...
	*/
	public function viewCommercial()
	{
		...
		return $this->render('@Client/Default/commercialTable.html.twig', $table);
	}
}